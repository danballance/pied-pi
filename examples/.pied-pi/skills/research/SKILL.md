...
description: Activated during the Research phase. Gather context, explore the codebase, and document findings before any design or implementation work.
---
...
2. **Explore the codebase** — Examine:
...
4. **Document findings** — Write a research document at `docs/{slug}/research.md` containing:
...
5. **Advance** — Present your findings to the user (this phase requires confirmation), then call `harness_advance` with a summary.
