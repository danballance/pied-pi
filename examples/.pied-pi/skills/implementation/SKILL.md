...
description: Activated during the Implementation phase. Execute the implementation plan autonomously, writing code and tests, verifying each task.
---
...
1. **Read the plan** — Load the implementation plan from `docs/{slug}/plan.md`.
