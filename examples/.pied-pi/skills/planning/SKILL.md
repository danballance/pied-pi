...
description: Activated during the Planning phase. Create a detailed implementation plan precise enough for autonomous execution.
---
...
1. **Review all prior artifacts** — Read:
   ...
   - Mock-ups/design artifacts (if they exist)
...
3. **Write the implementation plan** — Save to `docs/{slug}/plan.md`.
...
- DO reference prior artifacts (research, mockups) in the plan.
